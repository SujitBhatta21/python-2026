## Python codes for the Semantic Web Technologies and Knowledge Graphs module (2025/2026)

- **Laboratory 1**: Set up.
- **Laboratory 2**: Creating (small) RDF-based Knowledge Graphs
- **Laboratory 3**: Modelling OWL ontologies in Protégé.
- **Laboratory 4**: Reasoning with RDFS Semantics and OWL 2 RL
- **Laboratory 5**: Ontology Alignment
<!-- 
